        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="fade-in-up">
            ...
            <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
              <p>
                Привет! Я Максим Самсонов, пейзажный фотограф с более, чем тремя годами опыта в захвате потрясающих моментов природы. Моя страсть к фотографии началась с простого путешествия в Таиланд, на Пхукет, где я впервые осознал силу визуального повествования.
              </p>

              <p>
                Я обожаю пейзажную фотографию, уделяя особое внимание свету, композиции и эмоциям, которые передаёт каждое изображение.
              </p>
